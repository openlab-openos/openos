...
airdrops_enabled=1
node_sol=500 # 500 BTG: number of BTG to airdrop the node for transaction fees and vote account rent exemption (ignored if airdrops_enabled=0)
label=
identity=
vote_account=
no_restart=0
...
OPTIONS:
  ...
  --node-sol BTG            - Number of BTG this node has been funded from the genesis config (default: $node_sol)
