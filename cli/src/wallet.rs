    ...
    fn wallet_subcommands(self) -> Self {
        ...
        .subcommand(
            SubCommand::with_name("airdrop")
                .about("Request BTG from a faucet")
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount)
                        .required(true)
                        .help("The airdrop amount to request, in BTG"),
                )
                .arg(
            ...
            SubCommand::with_name("transfer")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .required(true)
                        .help("The amount to send, in BTG; accepts keyword ALL"),
                )
                .arg(
                    pubkey!(Arg::with_name("from")
                        .long("from")
...
pub fn process_airdrop(
    ...
    if let Ok(signature) = result {
        ...
        if current_balance < pre_balance.saturating_add(lamports) {
            ...
            println!("Run `openos confirm -v {signature:?}` for more info");
            Ok("".to_string())
        } else {
