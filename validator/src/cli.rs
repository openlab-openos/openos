        ...
        .arg(
            Arg::with_name("staked_nodes_overrides")
                ...
                .help("Provide path to a yaml file with custom overrides for stakes of specific
                            ...
                            Format of the file: `staked_map_id: {<pubkey>: <BTG stake amount>}"),
        )
        .arg(
    ...
    return App::new("solana-test-validator")
        ...
        .arg(
            Arg::with_name("json_rpc_url")
                ...
                .help(
                    "URL for Openos's JSON RPC or moniker (or their first letter): \
        ...
        .arg(
            Arg::with_name("faucet_sol")
                ...
                .help(
                    "Give the faucet address this much BTG in genesis. \
                     If the ledger already exists then this parameter is silently ignored",
                ),
        )
        .arg(
        ...
        .arg(
            Arg::with_name("faucet_per_time_sol_cap")
                ...
                .max_values(1)
                .help(
                    "Per-time slice limit for faucet requests, in BTG",
                ),
        )
        .arg(
            Arg::with_name("faucet_per_request_sol_cap")
                ...
                .max_values(1)
                .help(
                    "Per-request limit for faucet requests, in BTG",
                ),
        )
        .arg(
            Arg::with_name("geyser_plugin_config")
