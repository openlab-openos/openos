...
mod test {
    ...
    fn test_save() {
        ...
        let json_rpc_url = "https://api.mainnet.openverse.network";
        ...
        assert_eq!(
            ...
            format!(
                "---
json_rpc_url: https://api.mainnet.openverse.network
...
"
    ...
    fn test_load_serde_yaml_v_0_8_config() {
        ...
        writeln!(
            file,
            "---
json_rpc_url: \"http://api.devnet.openverse.network\"
update_manifest_pubkey:
  - 0
  - 0
  - 0
...
"
        ...
        assert_eq!(
            config,
            Config {
                json_rpc_url: String::from("http://api.devnet.openverse.network"),
