...
mod test {
    ...
    fn compute_websocket_url() {
        assert_eq!(
            Config::compute_websocket_url("http://api.devnet.openverse.network"),
            "ws://api.devnet.openverse.network".to_string()
        );

        assert_eq!(
            Config::compute_websocket_url("https://api.devnet.openverse.network"),
            "wss://api.devnet.openverse.network/".to_string()
        );
